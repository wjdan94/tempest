...
class BaseVolumesClient(rest_client.RestClient):
    ...
    #CHANGED
    def show_volume(self, volume_id, sp_id=None):
        """Returns the details of a single volume."""
	headers = {'sp_id' : sp_id}
	if sp_id != None:
            token, body = get_scoped_token.scoped_token_client().get_scoped_token()
	...
	resp, body = self.post('volumes', body=post_body, headers=headers)
	body = json.loads(body)
    ...
    #CHANGED 
    def delete_volume(self, volume_id, sp_id=None):
        ...
        if sp_id != None:
            ...
            headers['X-Auth-Token'] = token
            headers['Content-Type'] = 'application/json'
	resp, body = self.delete("volumes/%s" % str(volume_id), headers=headers)
    ...
    def is_resource_deleted(self, id, sp_id=None):
        try:
            self.show_volume(id, sp_id=sp_id)
